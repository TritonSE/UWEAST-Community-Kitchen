...
export default function AddMenuItemModal(props) {
  ...
  return (
    <>
      ...
      <Modal open={showModal} onClose={() => setShowModal(false)} className="modalContainer">
        <div className="modalBackground">
          {/* <div className="modalHeader">
                        <Button onClick={() =>setShowModal(false)}>X</Button>
                    </div> */}
          <div className="headerContainer">
            <IconButton className="closeModalButton" onClick={() => setShowModal("")}>
              <ClearIcon />
            </IconButton>
          </div>
                ...
                <div className="priceContainer">
                  ...
                  <FormControl
                    error={
                      menuError &&
                      ((individualItemPrice === "" && familyItemPrice === "") ||
                        parseInt(individualItemPrice) < 0)
                    }
                    margin="dense"
                    variant="outlined"
                  >
