...
const convertToTimeInt = (data) => {
  ...
  const dateTwo = new Date(
    `${date[2]}-${date[0]}-${date[1].length === 1 ? `0${date[1]}` : date[1]}T${formatedTime}:00`
  );
    ...
    options: {
      ...
      filterOptions: {
        ...
        logic(order, filters) {
          ...
          if (filters[0] === "Pending Orders") {
            return order !== "Pending Orders";
          }
          if (filters[0] === "Cancelled Orders") {
    ...
    options: {
      ...
      filterOptions: {
        ...
        logic: (location, filters, row) => {
          ...
          if (filters[0] === "Accepted") return location !== 1;
          if (filters[0] === "Rejected") return location !== 2;
          return location !== 3;
        },
      },
      filterType: "dropdown",
