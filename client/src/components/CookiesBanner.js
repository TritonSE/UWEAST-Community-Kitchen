...
const CookiesBanner = () => {
    ...
    return (
      <div style={{
          position: "fixed", bottom: "0", width: "100%", backgroundColor: "#333333", 
          color: "#f9ce1d", padding: "10px",  justifyContent: "space-between", alignItems: "center", zIndex: "45",
          opacity: "0.98", display: showBanner ? "flex": "none"
          }}>
        <div>This website uses cookies to ensure you get the best experience. <a href="https://www.cookiesandyou.com/" target="_blank" rel="noopener noreferrer" style={{cursor: "pointer"}}> Learn more. </a> </div>
