...
class Menu extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      cartPopupVisible:
        this.props.location && this.props.location.cartVisible
          ? this.props.location.cartVisible
          : false,
   ...
   * @returns
   */
  byteSize = (string) => new Blob([string]).size;
  ...
  handleAdd = (item) => {
    ...
    oldCookieFields.forEach((value, index) => {
          ...
          >
            ...
            <DialogContent>
              <DialogContentText id="alert-dialog-description">
                Item cannot be added. Cart is already full. If you'd like to make a larger order, we
                suggest that you <Link to="/contact">contact us</Link> directly so we can better
