    ...
    return (
      <div>
        <div className="disclaimer">
          <FormHelperText style={{ fontSize: "16px", color: "#747474" }} id="component-helper-text">
            {requiredAsterix()} Note: An email can be either a Primary Email, or a Secondary Email -
            not both.
          </FormHelperText>
        </div>
