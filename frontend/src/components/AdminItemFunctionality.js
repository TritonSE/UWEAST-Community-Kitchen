...
class AdminItemFunctionality extends Component {
                ...
                <Modal.Body>
                    <form>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" name="category" type="radio" value="Appetizers" required 
                        ...
                        <div class="form-check">
                            <input class="form-check-input" name="category" type="radio" value="Main Dishes" required 
                        ...
                        <div class="form-check">
                            <input class="form-check-input" name="category" type="radio" value="Sides" required 
                        ...
                        <div class="form-check">
                            <input class="form-check-input" name="category" type="radio" value="Drinks" required 
    ...
    render() {
      return (
          <div>
              {/* This is the contents on the old admin page */}
                <div class="col-12">	
  ...
  export default AdminItemFunctionality;
